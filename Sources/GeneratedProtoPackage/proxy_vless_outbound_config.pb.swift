...
public struct Xray_Proxy_Vless_Outbound_Config: Sendable {
...
fileprivate let _protobuf_package = "xray.proxy.vless.outbound"

extension Xray_Proxy_Vless_Outbound_Config: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
