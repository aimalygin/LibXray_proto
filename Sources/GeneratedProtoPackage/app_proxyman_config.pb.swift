...
public struct Xray_App_Proxyman_SniffingConfig: Sendable {
  ...
  public var domainsExcluded: [Xray_Common_Geodata_DomainRule] = []

  public var ipsExcluded: [Xray_Common_Geodata_IPRule] = []
...
extension Xray_App_Proxyman_SniffingConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.domainsExcluded) }()
      ...
      case 6: try { try decoder.decodeRepeatedMessageField(value: &self.ipsExcluded) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.domainsExcluded.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.domainsExcluded, fieldNumber: 3)
    }
    ...
    if !self.ipsExcluded.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.ipsExcluded, fieldNumber: 6)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Xray_App_Proxyman_SniffingConfig, rhs: Xray_App_Proxyman_SniffingConfig) -> Bool {
    ...
    if lhs.ipsExcluded != rhs.ipsExcluded {return false}
