...
public struct Xray_Proxy_Loopback_Config: Sendable {
...
fileprivate let _protobuf_package = "xray.proxy.loopback"

extension Xray_Proxy_Loopback_Config: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Config"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "inbound_tag"),
  ]
  ...
  public static func ==(lhs: Xray_Proxy_Loopback_Config, rhs: Xray_Proxy_Loopback_Config) -> Bool {
