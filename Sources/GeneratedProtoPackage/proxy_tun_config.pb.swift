...
public struct Xray_Proxy_Tun_Config: Sendable {
...
fileprivate let _protobuf_package = "xray.proxy.tun"

extension Xray_Proxy_Tun_Config: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
